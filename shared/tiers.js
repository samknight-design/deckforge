...
// Pricing reassessed to sit alongside ManaBox (PRO ~£1.99/mo · ~£18.99/yr).
// Scan/insight quotas are bounded by our real per-call AI cost (a scan ≈ £0.0025,
// an insight ≈ £0.025) so every tier stays profitable worst-case — unlike
// ManaBox, whose scanning is free to them. Our differentiator is AI insights.
export const TIERS = {
  free:      { key: 'free',      name: 'Free',      price: 0,    priceYear: 0,     scans: 50,   insights: 2,  decks: 1,    color: '#64748b', icon: '🆓', blurb: 'Get started' },
  pro:       { key: 'pro',       name: 'Pro',       price: 1.99, priceYear: 18.99, scans: 350,  insights: 10, decks: null, color: '#f59e0b', icon: '⚡', blurb: 'For regular players' },
  legendary: { key: 'legendary', name: 'Legendary', price: 6.99, priceYear: 64.99, scans: 1500, insights: 30, decks: null, color: '#a855f7', icon: '👑', blurb: 'For the hardcore' },
};
export const TIER_ORDER = ['free', 'pro', 'legendary'];

// One-off credit packs (never expire, used after the monthly quota). All highly
// profitable — the cost is pennies; they're priced against the Stripe fee and
// perceived value, while staying worse value/unit than a subscription.
export const BOLT_ONS = [
  ...
  { key: 'insights_10', label: '10 insights', kind: 'insight', amount: 10,  price: 3.99 },
];
